...
#SBATCH --job-name=ML.Approx.R2-repeat
...
#list of model
models=("CCE_optimal_old_all_global" "CCE_prank_new_all_global" "CCE_prank_new_early_global" "CCE_prank_old_all_global" "SUR_prank_old_early_global")
